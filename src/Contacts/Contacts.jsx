  ...
  return (
    <div className="background-contacts">
      ...
      <div className="contacts-card">
        <img className="contacts-pfp" src="https://i.ibb.co/34FxwnD/IMG-20220126-WA00001.jpg" />
        <div className="contacts-list">
          ...
          <img className="contacts-logo" src="https://i.ibb.co/927zwdH/linkedin-Contact.png"/>
            <p className="contacts-p">linkedin.com/in/andrea-di-mineo-958443230/</p>
          </div>
          <div className="contacts-row">
      ...
      <div className="contacts-card">
        <img className="contacts-pfp" src="https://i.ibb.co/7CkbJv7/foto-profilo.jpg" />
        <div className="contacts-list">
          <div className="contacts-row">
            <img className="contacts-logo" src="https://i.ibb.co/drhjLMc/gmail.png" />
          ...
          <div className="contacts-row">
          <img className="contacts-logo" src="https://i.ibb.co/927zwdH/linkedin-Contact.png"/>
            <p className="contacts-p">linkedin.com/in/alessandro-platania-b9158425a</p>
          </div>
          <div className="contacts-row">
          <img className="contacts-logo" src="https://i.ibb.co/ZfFbKq7/discord.png"/>
